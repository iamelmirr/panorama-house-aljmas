...
export function Footer() {
  ...
  return (
    <footer className="mt-16 bg-brand-charcoal text-brand-sand">
      <div className="container-grid grid gap-12 py-14 md:grid-cols-[2fr_1fr_1fr] md:items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-brand-sand/80">
            <Link
              href={SITE.instagram}
              target="_blank"
      ...
      <div className="border-t border-white/10">
        <div className="container-grid flex flex-col gap-2 py-6 text-sm text-brand-sand/70 sm:flex-row sm:items-center sm:justify-between">
          <p>© {year} {SITE.name}. Sva prava pridržana.</p>
          <p>Seoski turizam s pogledom na Dunav.</p>
        </div>
      </div>
    </footer>
  );
